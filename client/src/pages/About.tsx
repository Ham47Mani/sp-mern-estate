...
const About = () => {
  return (
    <main className="px-4 py-20 max-w-6xl mx-auto min-h-[calc(100vh-120px)]">
      <h1 className="text-3xl font-bold mb-4 text-slate-800">About SpaiderTech Estate</h1>
      <p className='mb-4 text-slate-700'>SpaiderTech Estate is a leading real estate agency that specializes in helping clients buy, sell, and rent properties in the most desirable neighborhoods. Our team of experienced agents is dedicated to providing exceptional service and making the buying and selling process as smooth as possible.</p>
