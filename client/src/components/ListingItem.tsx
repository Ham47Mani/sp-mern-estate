...
const ListingItem = ({listing}: listingItemProps) => {
  return (
    <Link to={`/listing/${listing._id}`} className='flex flex-col gap-4 w-full md:w-80 bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300'>
      {/* -------- Listing Image Cover -------- */}
